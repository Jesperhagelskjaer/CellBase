...
%     MClust_NeuralLoadingFunction=char([MClust_Directory 'LoadingEngines\LoadTT_NeuralynxNT']);
    MClust_NeuralLoadingFunction=char([MClust_Directory 'LoadingEngines\LoadTT_openephys']);
    MClust_TText = '.spikes';%'.ntt';
    MClust_FDext = '.fd';
...
%% LoadClusterData
    ...
    MClust_Clusters= temp.Clusters; %temp.MClust_Clusters;
