...
default_args={...
    ...
    'dt',0.000033 %0.001;... % new sampling rate sf=1/dt; 0.001=1000Hz
    'FieldSelectionArray',[1 0 0 0 1];...% only TimStamps and Samples
    'ExtractHeader',0;... % No Header
    'ExtractMode',1;... % All records
    'ExtractModeArray',[];... % Extract All records
...
for iC= 1:length(g.Channels)
    ...
    switch action
        case 'CSC1.Ncs'
            fname = 'CSC1.Ncs';new_fname='100_CH1.mat';
        case 'CSC2.Ncs'
            fname = 'CSC2.Ncs';new_fname='100_CH2.mat';
        case 'CSC3.Ncs'
            fname = 'CSC3.Ncs';new_fname='100_CH3.mat';
        case 'CSC4.Ncs'
            fname = 'CSC4.Ncs';new_fname='100_CH4.mat';
        case 'CSC5.Ncs'
            fname = 'CSC5.Ncs';new_fname='100_CH5.mat';
        case 'CSC6.Ncs'
            fname = 'CSC6.Ncs';new_fname='100_CH6.mat';
        case 'CSC7.Ncs'
            fname = 'CSC7.Ncs';new_fname='100_CH7.mat';
        case 'CSC8.Ncs'
            fname = 'CSC8.Ncs';new_fname='100_CH8.mat';
        case 'CSC9.Ncs'
            fname = 'CSC9.Ncs';new_fname='100_CH9.mat';
        case 'CSC10.Ncs'
            fname = 'CSC10.Ncs';new_fname='100_CH10.mat';
        case 'CSC11.Ncs'
            fname = 'CSC11.Ncs';new_fname='100_CH11.mat';
        case 'CSC12.Ncs'
            fname = 'CSC12.Ncs';new_fname='100_CH12.mat';
        case 'CSC13.Ncs'
            fname = 'CSC13.Ncs';new_fname='100_CH13.mat';
        case 'CSC14.Ncs'
            fname = 'CSC14.Ncs';new_fname='100_CH14.mat';
        case 'CSC15.Ncs'
            fname = 'CSC15.Ncs';new_fname='100_CH15.mat';
        case 'CSC16.Ncs'
            fname = 'CSC16.Ncs';new_fname='100_CH16.mat';
        case 'CSC17.Ncs'
            fname = 'CSC17.Ncs';new_fname='100_CH17.mat';
        case 'CSC18.Ncs'
            fname = 'CSC18.Ncs';new_fname='100_CH18.mat';
        case 'CSC19.Ncs'
            fname = 'CSC19.Ncs';new_fname='100_CH19.mat';
        case 'CSC20.Ncs'
            fname = 'CSC20.Ncs';new_fname='100_CH20.mat';
        case 'CSC21.Ncs'
            fname = 'CSC21.Ncs';new_fname='100_CH21.mat';
        case 'CSC22.Ncs'
            fname = 'CSC22.Ncs';new_fname='100_CH22.mat';
        case 'CSC23.Ncs'
            fname = 'CSC23.Ncs';new_fname='100_CH23.mat';
        case 'CSC24.Ncs'
            fname = 'CSC24.Ncs';new_fname='100_CH24.mat';
        case 'CSC25.Ncs'
            fname = 'CSC25.Ncs';new_fname='100_CH25.mat';
        case 'CSC26.Ncs'
            fname = 'CSC26.Ncs';new_fname='100_CH26.mat';
        case 'CSC27.Ncs'
            fname = 'CSC27.Ncs';new_fname='100_CH27.mat';
        case 'CSC28.Ncs'
            fname = 'CSC28.Ncs';new_fname='100_CH28.mat';
        case 'CSC29.Ncs'
            fname = 'CSC29.Ncs';new_fname='100_CH29.mat';
        case 'CSC30.Ncs'
            fname = 'CSC30.Ncs';new_fname='100_CH30.mat';
        case 'CSC31.Ncs'
            fname = 'CSC31.Ncs';new_fname='100_CH31.mat';
        case 'CSC32.Ncs'
            fname = 'CSC32.Ncs';new_fname='100_CH32.mat';
        case 'CSC33.Ncs'
            fname = 'CSC33.Ncs';new_fname='100_CH33.mat';
        case 'CSC34.Ncs'
            fname = 'CSC34.Ncs';new_fname='100_CH34.mat';
        case 'CSC35.Ncs'
            fname = 'CSC35.Ncs';new_fname='100_CH35.mat';
        case 'CSC36.Ncs'
            fname = 'CSC36.Ncs';new_fname='100_CH36.mat';
        case 'CSC37.Ncs'
            fname = 'CSC37.Ncs';new_fname='100_CH37.mat';
        case 'CSC38.Ncs'
            fname = 'CSC38.Ncs';new_fname='100_CH38.mat';
        case 'CSC39.Ncs'
            fname = 'CSC39.Ncs';new_fname='100_CH39.mat';
        case 'CSC40.Ncs'
            fname = 'CSC40.Ncs';new_fname='100_CH40.mat';
        case 'CSC1000.Ncs'
            fname = 'Events.nev';new_fname='events.mat';
            param2 = [1 1 1 1 1];
            param3 = 1;
            param4 = 1;
            param5 = [];
