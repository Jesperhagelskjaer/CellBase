...
events(i,:) = {'CenterPortLightOff','CenterPortLightOff', 'CenterPortLightOff', [-3 3]};    i = i + 1;
events(i,:) = {'SidePortEntry',     'SidePortEntry',      'SidePortEntry',      [-3 3]};    i = i + 1;
events(i,:) = {'SidePortExit',      'SidePortExit',       'SidePortExit',       [-3 3]};    i = i + 1;


% Variable events
events(i,:) = {'CenterPortLeave',   'CenterPortLightOff',         'CenterPortExit',        [-1 1]};    i = i + 1;
events(i,:) = {'SidePortLeave',     'SidePortEntry',              'SidePortExit',          [-1 1]};    i = i + 1;

% Define epochs for rate calculations
%               EpochLabel      ReferenceEvent     Window             RealWindow
i = 1;

epochs(i,:) = {'PostStimulus',       'CenterPortLightOff',  [0 0.05],       'FreeChoice'};    i = i + 1;
epochs(i,:) = {'PreStimulus',        'CenterPortLightOff',  [-0.05 0],      'FreeChoice'};    i = i + 1;
