function [score,chs_start] = PCA_calculation2(str,method,data,idx,chs_start)
...
for t = 1:t_end
    ...
    if strcmp(method,'single')
        for i = chs_start
            if sum(explained(end-17:end,i),1) > sum(Explained(end-17:end,i),1)*1.3 || explained(1,i) > 70 %(latent(1,i) > threshold_la(t) &&
