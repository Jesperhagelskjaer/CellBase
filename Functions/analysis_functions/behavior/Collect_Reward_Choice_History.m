...
function [RH, CH, NRH,Indices_to_erase] = Collect_Reward_Choice_History(TE)
...
CH           = Right_choice - Left_choice;  %(right == 1 ,left == -1)
RH           = Right        - Left;         %(right == 1 ,left == -1)
NRH          = No_Right     - No_Left;      %(right == 1 ,left == -1)
