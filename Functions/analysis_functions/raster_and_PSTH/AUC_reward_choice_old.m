...
%   function [AUC_past_choice_r,AUC_past_reward_right,AUC_past_choice_nr,AUC_past_reward_left,AUC_next_choice,AUC_next_choice_control] = AUC_reward_choice(cellid,path)
