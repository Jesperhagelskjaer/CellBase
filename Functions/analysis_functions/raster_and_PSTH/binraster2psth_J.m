function [psth, spsth, spsth_se] = binraster2psth_J(binraster,g)
...
spsth = smoothed_psth(psth,g.dt,g.sigma);
spsth_se = smoothed_psth(psth_sd ./ sqrt(NUM_TRIALS-1),g.dt,g.sigma);
